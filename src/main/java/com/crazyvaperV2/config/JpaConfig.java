...
@EnableJpaRepositories(basePackages = {"com.crazyvaperV2.dao"})
@ComponentScan(basePackages = "com.crazyvaperV2.entity")
...
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.crazyvaperV2.entity");
